...
export const metadata: Metadata = {
  ...
  description: 'フロントエンドエンジニア 片寄真実のプロフィールと職務経歴',
}
    ...
    <div className={pageHeaderStyles.container}>
      <header className={pageHeaderStyles.header}>
        ...
        <p className={pageHeaderStyles.description}>
          フロントエンドエンジニアとしてのプロフィールと職務経歴
        </p>
      </header>

      <section className={pageHeaderStyles.section}>
        <h2 className={pageHeaderStyles.sectionTitle}>プロフィール</h2>
        <div className={styles.profileText}>
          <p>
            フロントエンドエンジニアとして、モダンなWeb開発に携わっています。
          </p>
          <p>
            2020年3月からフリーランスエンジニアとして活動し、不動産関連Webサービス（Next.js
            +
      ...
      <section className={pageHeaderStyles.section}>
        <h2 className={pageHeaderStyles.sectionTitle}>職務経歴</h2>
