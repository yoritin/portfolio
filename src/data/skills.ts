...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Composition API', level: 'expert', years: 3 },
    ],
  },
  {
    category: 'バックエンド・API',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'e2eテスト', level: 'advanced', years: 2 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'モノレポ', level: 'advanced', years: 2 },
    ],
  },
  {
    category: '開発手法・設計',
    icon: '📐',
    skills: [
      { name: 'アジャイル開発', level: 'expert', years: 5 },
      { name: 'Atomic Design', level: 'advanced', years: 3 },
      { name: 'コンポーネント設計', level: 'expert', years: 5 },
    ],
  },
]
